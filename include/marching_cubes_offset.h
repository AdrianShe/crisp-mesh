...
//  r radius argument for marching cubes
//
//  Outputs:
...
void marching_cubes_offset(const Eigen::MatrixXd & V_1, const Eigen::MatrixXi & F_1, const double sigma, const int res, const double r, Eigen::MatrixXd & V_2, Eigen::MatrixXi & F_2, Eigen::MatrixXd & V_3, Eigen::MatrixXi & F_3, Eigen::MatrixXd & closest_point_cloud);
#endif
